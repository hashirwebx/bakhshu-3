...
const GirlsTraining: React.FC = () => {
  ...
  return (
    <section id="girls-training" ref={sectionRef} className="py-32 bg-gray-200 border-t border-gray-200 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">

        {/* Section Headline Header */}
        <div className="girls-header mb-20 relative">
          <h2 className="text-6xl md:text-[10rem] font-bebas text-black/5 absolute -top-16 md:-top-24 left-0 select-none tracking-tighter uppercase leading-none pointer-events-none">Strength</h2>
          <h3 className="text-4xl md:text-7xl font-bebas text-black tracking-widest uppercase relative z-10 leading-none">EMPOWERING YOUNG <span className="text-primary-red">GIRLS</span></h3>
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="girls-content-left relative">
            <div className="aspect-[4/5] bg-gray-50 rounded-none overflow-hidden border border-gray-200 shadow-2xl relative">
              <img
          ...
          <div className="girls-content-right space-y-10">
            <div className="inline-flex items-center space-x-2 bg-primary-red/10 px-4 py-2 rounded-none border border-primary-red/30">
            ...
            <h2 className="text-5xl md:text-7xl font-bold text-black mb-6 leading-none tracking-tight">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4">
              {[
                ...
                <div key={i} className="flex items-center space-x-4 group">
                  ...
                  <span className="text-black text-[11px] font-black uppercase tracking-widest leading-tight">
                    {feature.label}
                  </span>
                </div>
              ))}
