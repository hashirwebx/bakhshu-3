...
const WhyChooseUs: React.FC = () => {
  ...
  return (
    <section ref={sectionRef} className="bg-white py-32 px-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-6xl font-bold text-black mb-6 tracking-tight">Why Choose Our Academy?</h2>
        ...
        <div className="glass-container relative bg-white backdrop-blur-[40px] border border-gray-200 p-4 md:p-12 shadow-[0_40px_100px_rgba(0,0,0,0.1)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 relative z-20">
            {FEATURES.map((feature, i) => (
              <div
                key={i}
                className="feature-card bg-gray-50 backdrop-blur-2xl p-10 py-16 border border-gray-100 rounded-none hover:border-[#d9b943]hover:bg-white transition-all duration-500 flex flex-col items-center text-center group cursor-default shadow-sm hover:shadow-lg"
              >
                <div className="text-[#d9b943] mb-8 group-hover:scale-110 transition-all duration-500 drop-shadow-[0_0_15px_rgba(255,60,60,0.3)]">
                  {feature.icon}
                </div>
                <h3 className="text-black text-lg font-bold mb-4 tracking-tight group-hover:text-[#d9b943] transition-colors">{feature.title}</h3>
                <p className="text-gray-500 text-xs leading-relaxed font-bold uppercase tracking-widest opacity-80 group-hover:opacity-100">
                  {feature.desc}
                </p>
